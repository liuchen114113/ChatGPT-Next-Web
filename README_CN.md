...
> 示例：`+qwen-7b-chat,+glm-6b,-gpt-4o,gpt-4o-1106-preview=gpt-4o-turbo` 表示增加 `qwen-7b-chat` 和 `glm-6b` 到模型列表，而从列表中删除 `gpt-4o`，并将 `gpt-4o-1106-preview` 模型名字展示为 `gpt-4o-turbo`。
> 如果你想先禁用所有模型，再启用指定模型，可以使用 `-all,+gpt-4o`，则表示仅启用 `gpt-4o`
