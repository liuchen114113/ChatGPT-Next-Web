...
> Default: Empty
> Example: `+llama,+claude-2,-gpt-4o,gpt-4o-1106-preview=gpt-4o-turbo` means add `llama, claude-2` to model list, and remove `gpt-4o` from list, and display `gpt-4o-1106-preview` as `gpt-4o-turbo`.
